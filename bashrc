...
#export PYTHONPATH=/home/papag/python/:$PYTHONPATH
export PYTHONPATH=/home/papag/adaption/distribute/python:$PYTHONPATH
export LD_LIBRARY_PATH=/home/papag/adaption/build/lib:$LD_LIBRARY_PATH
export CAFFE_DIR=/home/papag/adaption/
...
function here_gui() { command nautilus . > /dev/null 2>&1 ;}
...
function info_host()   # Get current host related info.
	{
    ...
    echo -e "\n${BRed}Ethernet Local IP Address :$NC" ; my_ip enp1s0
